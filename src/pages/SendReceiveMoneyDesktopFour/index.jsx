            ...
            <div className="flex flex-col items-start justify-center w-full h-full left-0 bottom-0 right-0 top-0 m-auto absolute">
              <div className="h-[1581px] w-full relative md:h-[2581px]">
                ...
                <Img
                  ...
                  alt="image"
                  className="h-[150px] ml-[6rem] mt-10 md:h-[60px] md:ml-[2rem]"
                />
                <Button
                ...
                <div className="flex flex-col items-start justify-start w-[83%] h-full left-[6%] bottom-0 top-0 m-auto absolute md:top-[15rem]">
                  ...
                  <div className="flex flex-col items-start justify-start mt-[195px] md:mt-[10px]">
                    <Heading
                      size="3xl"
                      as="h1"
                      className="w-[92%] ml-[3px] md:ml-0  md:font-bold md:text-[30px]"
                    >
                      <>
                    ...
                    <Text
                      size="10xl"
                      as="p"
                      className="mt-[25px] !text-black-900_02 !font-poppins md:font-normal md:text-[12px]"
                    >
                      <>
                        You can send and also receive Money{" "}
                  ...
                  <div className="h-[593px] w-[44%] md:w-full mt-[79px] md:mt-[200px] relative">
                    ...
                    <div className="flex flex-col items-start justify-start gap-1 left-[3%] md:top-[-15%] top-[3%] m-auto absolute">
                      <Heading
                        as="h2"
                        className="md:text-[30px] md:font-bold md:mt-[-100px]"
                      >
                        Easy, Fast Payments{" "}
                      </Heading>
                      <Text
                        size="8xl"
                        as="p"
                        className="!text-black-900_02 !font-poppins md:text-[12px] md:font-normal"
                      >
                  ...
                  <div className="h-[593px] w-[44%] md:w-full mt-[79px] relative hidden md:block">
                    ...
                    <div className="flex flex-col items-start justify-start gap-1 left-[3%] md:top-[-8%] top-[3%] m-auto absolute">
                      <Heading
                        as="h2"
                        className="md:text-[30px] md:font-bold md:mt-[-80px]"
                      >
                      ...
                      <Text
                        ...
                        className="!text-black-900_02 !font-poppins md:text-[12px] md:font-normal"
                      >
                        Your can generate and instant receipt of payment in a
                        sec., for free
                      </Text>
                    </div>
                  </div>
                  <div className="h-[593px] w-[44%] md:w-full mt-[79px] relative hidden md:block">
                    ...
                    <div className="flex flex-col items-start justify-start gap-1 left-[3%] md:top-[-8%] top-[3%] m-auto absolute">
                      <Heading
                        ...
                        className="md:text-[30px] md:font-bold md:mt-[-100px]"
                      >
                        All Payments Highly Secured & Monitored{" "}
                      </Heading>
                      <Text
                        size="8xl"
                        as="p"
                        className="!text-black-900_02 !font-poppins md:text-[12px] md:font-normal"
                      >
                        Your Payments are Highly secured with a backend
                        encrypted{" "}
                      </Text>
                    </div>
                  </div>
              ...
              <div className="flex flex-col items-center justify-start h-[532px] w-[532px] sm:w-full sm:h-auto">
                <div className="flex flex-col items-center justify-start h-[532px] w-[532px] sm:w-full sm:h-auto">
                  ...
                  <Text
                    size="8xl"
                    as="p"
                    className="w-[83%] mt-[-520px] !text-black-900_02 !font-poppins"
                  >
