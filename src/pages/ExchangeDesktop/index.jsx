            ...
            <div className="flex flex-col items-start justify-center w-full h-full left-0 bottom-0 right-0 top-0 m-auto absolute">
              <div className="h-[1581px] w-full relative">
                ...
                <Img
                  ...
                  alt="image"
                  className="h-[150px] md:ml-[3rem] ml-[6rem] mt-10 md:h-[60px]"
                />
                <Button
                ...
                <div className="flex flex-col items-start justify-start w-[83%] left-[6%] top-0 m-auto absolute md:top-[15rem]">
                  ...
                  <Heading
                    size="3xl"
                    as="h1"
                    className="w-[42%] mt-[195px] ml-0.5 md:ml-0 md:font-bold md:text-[30px]  md:mt-[-6rem] md:w-full"
                  >
                  ...
                  <Text
                    size="10xl"
                    as="p"
                    className="w-[47%] mt-[25px] !text-black-900_02 !font-poppins md:w-full md:font-normal md:text-[12px]"
                  >
                    <>
                      Convert your currency to over 5 foreign{" "}
                  ...
                  <Heading
                    size="xl"
                    as="h2"
                    className="w-[22%] mt-[108px] mb-[20px] ml-6 md:ml-0 sm:ml-5 z-[1] md:font-bold md:text-[30px]  md:mt-[39rem] md:w-full"
                  >
                    <>
                  ...
                  <div className="flex flex-col items-center justify-start w-[57%] md:w-full gap-[30px] mr-[-9rem]">
                    ...
                    <div className="flex-col items-center justify-start w-full pt-[5px] gap-5 hidden md:block">
                      ...
                      <Text
                        size="5xl"
                        as="p"
                        className="!text-gray-900_01 text-center"
                      >
                        At TedFinance, we believe finances shouldn&#39;t be
                        confined by borders. Our innovative wallet app empowers
                        you to send, receive, and manage your money globally
                        with ease. We understand the complexities of navigating
                        currency exchange, and that&#39;s why we offer a
                        solution that simplifies the process.
                      </Text>
                    </div>
                  </div>
                </div>
                ...
                <div className="h-[499px] w-[39%] md:w-[85%] mt-[19px] md:mt-0 relative">
                  ...
                  <div className="flex flex-col items-center justify-start w-[53%] gap-[13px] left-[3%] top-[2%] m-auto absolute md:w-full">
                    <Heading
                      size="xl"
                      as="h3"
                      className="md:text-[30px]  md:mt-[1rem] md:w-full"
                    >
                      Swift Conversion
                    </Heading>
                    <Text
                      size="xl"
                      as="p"
                      className="!text-black-900_02 !font-poppins md:w-full md:font-normal md:text-[12px]"
                    >
                ...
                <div className="flex flex-col items-center justify-start w-[57%] md:w-full gap-[30px] mr-[-9rem]  md:hidden">
                  ...
                  <div className="flex flex-col items-center justify-start w-full pt-[5px] gap-5">
                    ...
                    >
                      At TedFinance, we believe finances shouldn&#39;t be
                      confined by borders. Our innovative wallet app empowers
                      you to send, receive, and manage your money globally with
                      ease. We understand the complexities of navigating
                      currency exchange, and that&#39;s why we offer a solution
