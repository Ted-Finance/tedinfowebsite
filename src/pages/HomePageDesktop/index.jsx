        ...
        <div className="flex flex-row md:flex-col justify-start items-start w-[40%] gap-7 left-[7%] top-[10%] md:top-[8%] m-auto md:gap-5 absolute md:ml-[5.2rem]">
          ...
          <div className="w-[390px] relative mt-[15rem] ml-[-5rem]">
            <Img
              ...
              alt="image_phone"
              className="w-[390px] hidden md:block h-[430px] left-0 bottom-0 right-0 top-0 m-auto object-cover absolute rounded-[35px]"
            />
          </div>
                  ...
                  <div className="flex flex-row md:flex-col justify-start items-start w-full md:gap-5">
                    ...
                    {isOpenHam && (
                      <div
                        ...
                        style={{ marginTop: '-53rem', width: '100vw', height: '100vh' }}
                      >
                  ...
                  <div className="flex flex-row justify-start w-[48%] md:w-full mt-[-200px] ml-[122px] md:ml-5">
                    <div className="flex flex-col items-start justify-start w-full gap-5">
                      ...
                      <div className="flex flex-col items-center justify-start gap-3.5 md:w-[90vw]">
                        <Heading as="h2" className="!text-gray-900_01 md:text-[28px] md:font-semibold text-[38px] font-bold leading-[150%]  md:text-center md:text-align-center md:mr-[1.5rem]">
                          <>
                            Welcome to TedFinance <br className="md:hidden" />
                            Your Secure, Streamlined Global Financial access.
                          </>
                        </Heading>
                        <Heading size="md" as="h3" className="!text-gray-900_03 leading-[150%] md:text-center md:text-align-center md:mr-[1.5rem] md:font-bold md:text-[14px]">
              ...
              <div className="flex flex-col items-start justify-start w-[82%] top-[2%] md:top-[9%] right-0 left-0 m-auto absolute">
                <div className="flex flex-row md:flex-col justify-between items-center w-full md:gap-10">
                  <div className="flex flex-col items-start justify-start w-[52%] md:w-full gap-[19px]">
                    <Text size="12xl" as="p" className="!text-purple-400 md:w-full text-[48px] md:text-[28px]  font-medium md:text-center md:text-align-center">
                      About Wallet
                    </Text>
                    <Text size="5xl" as="p" className="!text-gray-900_01 text-[20px] md:text-center md:text-align-center md:text-[14px] font-medium">
                      <>
                  ...
                  <div className="flex flex-row justify-center w-[28%] md:w-full p-3.5 border-purple-400 border border-solid bg-purple-400 rounded-[41px]">
                    <Button color="light_blue_300" size="xl" shape="round" className="sm:px-5 min-w-[181px] md:w-full text-[18px] md:text-[14px] font-normal">
                      For Individuals
                    </Button>
                    <div className="flex flex-row justify-center w-[50%] p-[15px] md:w-full">
                      <Text as="p" className="!text-white-A700 text-center md:text-[14px] text-[18px] font-normal">
                        For Businesses
                      </Text>
                    </div>
                  </div>
                ...
                <div className="flex flex-row md:flex-col items-center w-full mt-[41px] gap-[100px] md:gap-[25px]">
                  <div className="flex flex-col items-center justify-start w-[29%] md:w-full gap-[30px]">
                    ...
                    <div className="flex flex-col items-center justify-start w-full gap-5">
                      <Text size="7xl" as="p" className="!text-purple-400 text-center md:text-[20px] text-[24px] font-normal">
                        Send & Receive Money from all Countries{" "}
                      </Text>
                      <Text size="5xl" as="p" className="!text-gray-900_01 text-center md:text-[14px] text-[20px] font-medium">
                ...
                <div className="flex flex-col items-start justify-start w-full mt-[97px] md:mt-[40px] gap-5 md:px-5 max-w-[1104px]">
                  <Text size="12xl" as="p" className="!text-purple-400 md:text-[28px] text-[48px] font-medium md:text-center md:text-align-center">
                    Our Virtual USD Dollar Card
                  </Text>

                  <Text size="5xl" as="p" className="!text-gray-900_01 md:text-center md:text-align-center md:text-[14px] text-[20px] font-medium">
                ...
                <div className="flex flex-col items-center justify-start w-full mt-[86px] gap-[60px]">
                  <div className="flex flex-row md:flex-col justify-between items-center w-full md:gap-10">
                    ...
                    <div className="flex flex-col items-start justify-start w-[56%] md:w-full gap-[62px]">
                      <div className="flex flex-col items-start justify-start w-full gap-3.5">
                        <Text size="9xl" as="p" className="!text-purple-400 md:text-[20px] md:font-medium md:text-center md:text-align-center">
                          Make seamless international payments
                        </Text>
                        <Text size="5xl" as="p" className="!text-gray-900_01 md:text-center md:text-align-center md:text-[14px] md:font-medium">
                        ...
                        <div className="flex flex-row justify-start w-[29%] md:w-full">
                          <div className="flex flex-row justify-start items-center w-full gap-px">
                            <div className="flex flex-col items-start justify-start w-full gap-2.5">
                              <Text size="13xl" as="p" className="!text-transparent bg-gradient4 bg-clip-text md:w-full md:text-[40px] md:font-medium md:text-center md:text-align-center ">
                                99.9%
                              </Text>
                              <Text size="5xl" as="p" className="!text-gray-900_01 md:w-full md:text-[14px] md:font-medium md:text-center md:text-align-center">
                      ...
                      >
                        <Text as="p" className="!text-white-A700 md:text-[14px] md:font-medium md:text-center md:text-align-center">
                          Learn More
                        </Text>
                      </a>
                    </div>
                    ...
                    <div className="h-[534px] md:h-[500px] w-[47%] pb-[50px] pl-[50px] md:pb-5 md:pl-5 bg-gradient4 relative rounded-[20px] md:w-full">
                      ...
                      <div className="w-[85%] gap-5 grid-cols-2 bottom-[9%] left-[8%] m-auto sm:grid-cols-2 sm:gap-5 grid absolute">
                        <div className="flex flex-col items-center justify-start w-full gap-6 p-[30px] sm:p-5 bg-purple-500 rounded-[16px]">
                          ...
                          <Text size="5xl" as="p" className="!text-white-A700 text-center !font-normal md:text-sm">
                  ...
                  <div className="flex-col items-start justify-start w-[47%] md:w-full gap-[62px] hidden md:block">
                    <div className="flex flex-col items-center justify-start gap-3.5">
                      ...
                      <Text size="5xl" as="p" className="!text-gray-900_01 md:text-[14px] md:font-medium md:text-center md:text-align-center">
                        Manage your spending effortlessly with real-time transaction notifications and the ability to
                        instantly block or unblock your card including Benefit from advanced security features like
                        two-factor authentication and in-app card controls to safeguard your financial information.
                      </Text>
                    ...
                    <div className="flex flex-row sm:flex-col justify-between items-center w-full sm:gap-10 md:mt-[2rem]">
                      <div className="flex flex-col items-start justify-start w-[24%] sm:w-full gap-2.5">
                        ...
                        <Text size="5xl" as="p" className="!text-gray-900_01  md:w-full md:text-[14px] md:font-light md:text-center md:text-align-center">
                          Cash Flow Management
                        </Text>
                      </div>
                    ...
                    >
                      <Text as="p" className="!text-white-A700 md:text-[14px] md:w-full md:md:w-full md:text-center md:text-align-center ">
                        Learn More
                      </Text>
                    </a>
                  </div>
                ...
                <div className="flex flex-col items-start justify-start w-full mt-[81px] gap-[18px] md:px-5 max-w-[1104px] md:mt-[50px]">
                  <Text size="12xl" as="p" className="!text-lime-500 md:w-full ">
                    <span className="text-purple-400 md:hidden">Our</span>
                    <span className="text-purple-400 md:hidden">Features</span>
                    <span className="text-purple-400 hidden md:block md:text-[28px] md:font-medium md:text-center md:text-align-center">Our Features</span>
                  </Text>
                  <Text size="5xl" as="p" className="!text-gray-900_01 md:full md:text-[14px] md:font-medium md:text-center md:text-align-center">
                    ...
                    <div className="justify-center w-full gap-[30px] grid-cols-2 md:grid-cols-1 md:gap-5 grid">
                      <div className="flex flex-col items-center justify-start w-full gap-[30px] p-[50px] md:p-5 bg-purple-A100_05 rounded-[12px]">
                        <div className="flex flex-row justify-between items-center w-full">
                          <Text size="6xl" as="p" className="!text-gray-900_01 md:text-[18px] md:font-normal">
                            24/7 Account Access
                          </Text>
                          <Img src="images/img_icon_lime_500.svg" alt="247_account" className="h-[34px] w-[34px] md:h-[24px] md:w-[24px]" />
                        </div>
                        <Text size="5xl" as="p" className="!text-white-A700 tracking-[-0.12px] md:text-[14px] md:font-light">
                      ...
                      <div className="flex flex-col items-center justify-start w-full gap-[30px] p-[50px] md:p-5 bg-light_blue-300 rounded-[12px]">
                        <div className="flex flex-row justify-between items-center w-full">
                          ...
                          <Img src="images/img_icon_lime_500.svg" alt="icon_one" className="h-[34px] w-[34px] md:h-[24px] md:w-[24px]" />
                        </div>
                        <Text size="5xl" as="p" className="!text-purple-400 tracking-[-0.12px] md:text-[14px] md:font-light">
                      ...
                      <div className="flex flex-col items-center justify-start w-full gap-[30px] p-[50px] md:p-5 bg-purple-A100_05 rounded-[12px]">
                        ...
                        <Text size="5xl" as="p" className="mb-[30px] !text-white-A700 tracking-[-0.12px] md:text-[14px] md:font-light">
                ...
                <div className="flex flex-col items-start justify-start mt-10 gap-5">
                  <Text size="12xl" as="p" className="!text-lime-500 md:text-center md:text-align-center md:w-full">
                    <span className="text-purple-400 md:hidden">Frequently</span>
                    <span className="text-purple-400 md:hidden">Asked Questions</span>
                    <span className="text-purple-400 md:block hidden md:text-[28px] md:font-medium">Frequently Asked Questions</span>
                  </Text>
                  <Text size="5xl" as="p" className="!text-gray-900_01 md:text-center md:text-align-center md:w-full md:text-[14px] md:font-light">
                  ...
                  <div className="flex flex-col items-center justify-start w-full">
                    <div className="justify-center w-full gap-[30px] grid-cols-2 md:grid-cols-1 md:gap-5 grid">
                      <div className="flex flex-col items-start justify-center w-full gap-7 p-[50px] md:p-5 border border-solid purple_400_light_blue_300_border rounded-[14px]">
                        <Text size="5xl" as="p" className="!text-purple-400 md:text-[18px] md:font-medium">
                          How do I open an account with TedFinance?
                        </Text>
                        <div className="h-px w-full mx-auto bg-gradient4 max-w-[587px]" />
                        <Text as="p" className="!text-purple-400 !font-medium md:text-[14px] md:font-normal">
                ...
                <div className="flex flex-row md:flex-col justify-start items-center w-full mt-[130px] gap-2 md:gap-5">
                  <div className="flex flex-col items-start justify-start w-[76%] md:w-full gap-[15px]">
                    <Text size="12xl" as="p" className="!text-purple-400 md:w-full">
                      <span className="text-purple-400 md:hidden">Our</span>
                      <span className="text-lime-500 md:hidden"></span>
                      <span className="text-purple-400 md:hidden">Security</span>
                      <span className="text-purple-400 md:text-[20px] md:font-medium md:text-center md:text-align-center hidden md:block">Our Security</span>
                    </Text>
                    <Text size="5xl" as="p" className="!text-gray-900_01 md:w-full md:text-[14px] md:font-medium md:text-center md:text-align-center">
                  ...
                  <div className="flex flex-row justify-center w-[25%] md:w-full p-3.5 bg-purple-400 rounded-[41px]">
                    <Button color="light_blue_300" size="xl" shape="round" className="sm:px-5 min-w-[161px] md:text-[14px] md:font-normal">
                      BVN/SELFIE
                    </Button>
                    <div className="flex flex-row justify-center w-[49%] p-[15px]">
                      <Text as="p" className="!text-white-A700 text-center  md:w-full md:text-[14px] md:font-normal">
                        National ID
                      </Text>
                    </div>
                  </div>
                    ...
                    {currentIndex === 0 && (
                      <div className="flex flex-col items-center justify-start w-[29%] md:w-full gap-[52px]">
                        <Img
                          ...
                          className="w-full md:h-[60px] object-cover"
                        />
                        <Heading size="md" as="h4" className="!text-purple-400  md:text-[20px] md:font-semibold md:text-center md:text-align-center">
                          Data Security{" "}
                        </Heading>
                        <Text as="p" className="!text-purple-400 !font-medium md:mt-[-24px] md:w-full md:text-[14px] md:font-normal md:text-center md:text-align-center">
                          <>
                            Encryption: We employ industry-standard encryption methods to protect your sensitive data,
                            both in transit and at rest. This means your information is scrambled and unreadable by
                            unauthorized individuals.
                    ...
                    {currentIndex === 1 && (
                      <div className="flex flex-col items-center justify-start w-[29%] md:w-full gap-[52px]">
                        <Img
                          ...
                          className="w-full md:h-[60px] object-cover"
                        />
                        <Heading size="md" as="h5" className="!text-purple-400 md:text-[20px] md:font-semibold md:text-center md:text-align-center">
                          Account Security
                        </Heading>
                        <Text as="p" className="!text-purple-400 !font-medium md:mt-[-24px] md:w-full md:text-[14px] md:font-normal md:text-center md:text-align-center">
                          <>
                    ...
                    {currentIndex === 2 && (
                      <div className="flex flex-col items-center justify-start w-[29%] md:w-full gap-[52px]">
                        <Img
                          ...
                          className="w-full md:h-[60px] object-cover"
                        />
                        <Heading size="md" as="h6" className="!text-purple-400 md:text-[20px] md:font-semibold md:text-center md:text-align-center">
                          Transparency and Communication
                        </Heading>
                        <Text as="p" className="!text-purple-400 !font-medium md:mt-[-24px] md:w-full md:text-[14px] md:font-normal md:text-center md:text-align-center">
                          <>
                ...
                <div className="flex flex-row justify-start w-full mt-[306px] pb-14 md:pb-5 border border-solid lime_500_33_lime_500_33_border md:bg-gray-900_05 bg-purple-400 rounded-[20px] md:mt-[5rem]">
                  <div className="flex flex-row md:flex-col justify-between items-center w-full mx-auto md:gap-10 md:px-5 max-w-[1324px]">
                    ...
                    <Button color="white_A700" size="4xl" className="sm:px-5 font-medium min-w-[185px] rounded-[31px] md:font-bold md:text-[20px] md:text-center md:text-align-center">
                      Open Account
                    </Button>
                  </div>
                </div>
                    ...
                    <div className="flex flex-col items-center justify-start w-full gap-[49px]">
                      ...
                      <div className="flex flex-row md:flex-col justify-start items-center w-full pl-[326px] pr-14 gap-5 md:px-5">
                        ...
                        <div className="flex flex-row justify-start items-center w-[31%] md:w-full gap-1.5">
                          ...
                          <Text as="p" className="w-[100%] md:text-center md:text-align-center md:font-normal md:text-[15px]">
                            <>
                      ...
                      <div className="flex flex-row md:flex-col justify-between items-center w-full p-4 md:gap-10 border-gray-900_04 border border-solid bg-gray-900 rounded-[42px]">
                        ...
                        <Text as="p" className="!text-gray-400 !font-light md:font-normal md:text-[15px]">
                        ...
                        <div className="flex flex-row justify-start items-center w-[21%] md:w-full mr-3.5 md:mr-[-3rem] gap-3">
                          <a href="#">
                            <Text as="p" className="!text-gray-400 !font-light md:text-center md:text-align-center md:w-full md:font-normal md:text-[15px]">
                              Privacy Policy
                            </Text>
                          </a>
