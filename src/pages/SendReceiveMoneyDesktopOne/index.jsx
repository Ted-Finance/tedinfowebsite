        ...
        <div className="flex flex-col items-center justify-start w-full">
          <div className="h-[1581px] w-full md:px-5 relative max-w-[1710px]">
            ...
            <div className="flex flex-col items-center justify-start w-[33%] left-[9%] top-[17%] m-auto absolute  md:top-[15rem] md:w-full">
              <Heading size="3xl" as="h1" className="!font-bold mr-[12.5rem] md:mr-[0rem] md:text-[30px]  md:mt-[-6rem] md:w-full">
                <>
                  Smart Virtual <br className="md:hidden" />
                  US Dollar Card
                </>
              </Heading>
              <Text size="8xl" as="p" className=" !text-black-900_02 !font-poppins mt-[2rem] md:w-full md:font-normal md:text-[12px] md:mt-[0rem]">
                <>
                  You can now Shop online, Pay subscription <br className="md:hidden" />
                  and lots more with TedFinance Smart Virtual <br className="md:hidden" />
                  US Dollar Card{" "}
                </>
              </Text>
            </div>
            ...
            <div className="flex flex-col items-start justify-start w-[35%] bottom-[-5%] md:bottom-[5rem] md:left-[10.5%] left-[8%] m-auto absolute md:w-[80%]">
              <Heading as="h2" className="!font-bold md:text-[26px]  md:mt-[-10rem] md:w-full">Enjoy Cashless Shopping</Heading>
              <Text size="8xl" as="p" className="mt-[5px] !text-black-900_02 !font-poppins z-[1] md:w-[85%] md:font-normal md:text-[12px] md:mt-[0rem]">
            ...
            <div className="flex-col items-start justify-start w-[35%] bottom-[-26rem] md:left-[10.5%] left-[8%] m-auto absolute md:w-[80%] hidden md:block">
              <Heading as="h2" className="!font-bold md:text-[26px]  md:mt-[-10rem] md:w-full">Pay Subscriptions</Heading>
              <Text size="8xl" as="p" className="mt-[5px] !text-black-900_02 !font-poppins z-[10] md:w-[85%] md:font-normal md:text-[12px] md:mt-[0rem]">
            ...
            <div className="flex-col items-start justify-start w-[35%] bottom-[-60rem] md:left-[10.5%] left-[8%] m-auto absolute md:w-[80%] hidden md:block">
              <Heading as="h2" className="!font-bold md:text-[26px]  md:mt-[-10rem] md:w-full">Pay for your Travels with the Virtual USD Card</Heading>
              <Text size="8xl" as="p" className="mt-[5px] !text-black-900_02 !font-poppins z-[1] md:w-[85%] md:font-normal md:text-[12px] md:mt-[0rem]">
                Your Tourist is covered with your TedFinance Virtual
                US Dollar Card
              </Text>
              <Img
            ...
            <div className="flex-col items-start justify-start w-[35%] bottom-[-95rem] md:left-[10.5%] left-[8%] m-auto absolute md:w-[80%] hidden md:block">
              <Heading as="h2" className="!font-bold md:text-[26px]  md:mt-[-10rem] md:w-full">We have your Funds Secured Always</Heading>
              <Text size="8xl" as="p" className="mt-[5px] !text-black-900_02 !font-poppins z-[1] md:w-[85%] md:font-normal md:text-[12px] md:mt-[0rem]">
            ...
            <Img src="images/Logo-one-white.svg" alt="image" className="h-[164px] ml-[9rem] mt-10 md:ml-[1rem] md:h-[60px]" />
            <Button
            ...
            {isOpenHam && (
              <div
                ...
                style={{ marginTop: '-100rem', width: '100vw', height: '100vh' }}
              >
          ...
          <div className="flex flex-row md:flex-col justify-between w-full mt-[29px] md:gap-10 md:px-5 max-w-[1333px] mr-[-2rem] md:hidden">
            ...
            <div className="flex flex-row md:flex-col justify-between w-auto gap-[52px] md:gap-10">
              <Heading as="h3" className="w-[52%] text-center text-align-center">
                <>
              ...
              <Heading as="h4" className="w-[43%] text-center text-align-center">
                <>
          ...
          <div className="flex flex-col items-center justify-start w-full mt-6 gap-[35px] md:px-5 max-w-[1389px] mr-[-5rem] md:hidden">
            <div className="flex flex-row md:flex-col justify-center items-start w-[98%] md:w-full md:gap-5">
              <Text size="8xl" as="p" className="w-[29%] mt-3.5 md:mt-0 !text-black-900_02 !font-poppins text-center text-align-center">
                <>
                  Your can generate and instant receipt of payment in a sec.,
                  for free{" "}
                </>
